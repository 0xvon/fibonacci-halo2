...
impl<F: FieldExt> FibonacciChip<F> {
    ...
    pub fn configure(meta: &mut ConstraintSystem<F>) -> FibonacciConfig {
        ...
        meta.create_gate("add", |meta| {
            ...
            // gate constraint
            // define the equality which is equal to "0"
            vec![s * (a + b - c)]
        });
    ...
    pub fn assign_first_row(
        ...
        layouter.assign_region(
            ...
            |mut region| {
                ...
                // a[0] + b[0] -> c[0]
                // to hide the value as advice column, calculate the column from a and b
...
mod tests {
    ...
    fn plot_fibonacci1() {
        ...
        let root = root.titled("Fib 1 Layout", ("san-serif", 60)).unwrap();
